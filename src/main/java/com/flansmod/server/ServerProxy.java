...
public class ServerProxy extends CommonProxy {
    ...
    public void syncConfig() {
        ...
        FlansMod.damageMark = configFile.getString("damageMark", Configuration.CATEGORY_GENERAL, FlansMod.damageMark, "Lore Damage Keyword.");
        FlansMod.bulletSpeedMark = configFile.getString("bulletSpeedMark", Configuration.CATEGORY_GENERAL, FlansMod.bulletSpeedMark, "Lore BulletSpeed Keyword.");
    ...
    private String getData() {
        return FlansMod.damageMark + "|"
                + FlansMod.bulletSpeedMark + "|"
                + FlansMod.recoilMark + "|"
