...
public class FlansModClient extends FlansMod {
    ...
    public void renderLiving(RenderPlayerEvent.Pre event) {
        ...
        if (event.entity instanceof EntityPlayer && teamInfo != null && PacketTeamInfo.gametype != null && !"No Gametype".equals(PacketTeamInfo.gametype)) {
            PlayerScoreData rendering = PacketTeamInfo.getPlayerScoreData(event.entity.getCommandSenderName());
            PlayerScoreData thePlayer = PacketTeamInfo.getPlayerScoreData(minecraft.thePlayer.getCommandSenderName());
    ...
    public static boolean isCurrentMap(String map) {
        return !(teamInfo == null || PacketTeamInfo.mapShortName == null) && PacketTeamInfo.mapShortName.equals(map);
    }
