...
public class RenderGun implements IItemRenderer {
    ...
    public void renderGun(ItemStack item, GunType type, float f, ModelGun model, GunAnimations animations, float reloadRotate) {
        ...
        if (scopeAttachment != null) GL11.glTranslatef(0F, -scopeAttachment.model.renderOffset / 16F, 0F);
     ...
     * Gun render method, seperated from transforms so that mecha renderer may also call this
     */
    private void renderGun(ItemStack item, GunType type, float f, ModelGun model, GunAnimations animations, float reloadRotate, ItemRenderType renderType) {
        GL11.glPushMatrix();
        if (renderType == ItemRenderType.EQUIPPED_FIRST_PERSON) {
            ...
            GL11.glRotatef(-(animations.lastGunRecoil + (animations.gunRecoil - animations.lastGunRecoil) * smoothing) * -8.0F, 0.0F, 0.0F, 1.0F);
        ...
        renderGun(item, type, f, model, animations, reloadRotate);
