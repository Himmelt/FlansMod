...
public class FlansMod {
    ...
    public static String damageMark = "Damage";
    public static String bulletSpeedMark = "BulletSpeed";
    ...
    public static final String VERSION = "1.7.10-4.10.1";
    @Instance(MODID)
    ...
    @SidedProxy(
            ...
            serverSide = "com.flansmod.common.ServerProxy"
    )
