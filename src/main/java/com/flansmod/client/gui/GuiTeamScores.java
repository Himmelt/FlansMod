...
public class GuiTeamScores extends GuiScreen {
    ...
    public void renderTwoTeamGUI(PacketTeamInfo teamInfo) {
        ...
        func_146110_a(m, n + 66 + PacketTeamInfo.numLines * 9, 100, 168, 312, 12, 512, 256);
        ...
        drawString(fontRendererObj, PacketTeamInfo.map, m + 6, n + 6, 0xffffff);
        drawString(fontRendererObj, PacketTeamInfo.gametype, m + 312 - 6 - fontRendererObj.getStringWidth(PacketTeamInfo.gametype), n + 6, 0xffffff);
        ...
        if (teamInfo.roundOver()) {
            ...
            drawString(fontRendererObj, "Score Limit : " + PacketTeamInfo.scoreLimit, m + 302 - fontRendererObj.getStringWidth("Score Limit : " + PacketTeamInfo.scoreLimit), n + 20, 0xffffff);
        }

        for (int i = 0; i < 2; i++) {
            fontRendererObj.drawString("\u00a7" + PacketTeamInfo.teamData[i].team.textColour + PacketTeamInfo.teamData[i].team.name, m + 10 + 151 * i, n + 39, 0xffffff);
            fontRendererObj.drawString("\u00a7" + PacketTeamInfo.teamData[i].team.textColour + PacketTeamInfo.teamData[i].score, m + 133 + 151 * i, n + 39, 0xffffff);
            for (int j = 0; j < PacketTeamInfo.teamData[i].numPlayers; j++) {
                drawString(fontRendererObj, PacketTeamInfo.teamData[i].playerData[j].username, m + 12 + 151 * i, n + 67 + 9 * j, 0xffffff);
                drawCenteredString(fontRendererObj, "" + PacketTeamInfo.teamData[i].playerData[j].score, m + 111 + 151 * i, n + 67 + 9 * j, 0xffffff);
                drawCenteredString(fontRendererObj, "" + (PacketTeamInfo.showZombieScore ? PacketTeamInfo.teamData[i].playerData[j].zombieScore : PacketTeamInfo.teamData[i].playerData[j].kills), m + 127 + 151 * i, n + 67 + 9 * j, 0xffffff);
                drawCenteredString(fontRendererObj, "" + PacketTeamInfo.teamData[i].playerData[j].deaths, m + 143 + 151 * i, n + 67 + 9 * j, 0xffffff);
            }
        }
    ...
    public void renderDMGUI(PacketTeamInfo teamInfo) {
        ...
        drawCenteredString(fontRendererObj, PacketTeamInfo.gametype, k / 2, n + 4, 0xffffff);
        drawString(fontRendererObj, "Name", m + 8, n + 14, 0xffffff);
        drawString(fontRendererObj, "Score", m + 100, n + 14, 0xffffff);
        drawString(fontRendererObj, "Kills", m + 150, n + 14, 0xffffff);
        drawString(fontRendererObj, "Deaths", m + 200, n + 14, 0xffffff);
        int line = 0;
        if (PacketTeamInfo.sortedByTeam) {
            for (int p = 0; p < PacketTeamInfo.numTeams; p++) {
                if (PacketTeamInfo.teamData[p] == null || PacketTeamInfo.teamData[p].team == null)
                    continue;
                drawString(fontRendererObj, "\u00a7" + PacketTeamInfo.teamData[p].team.textColour + PacketTeamInfo.teamData[p].team.name, m + 8, n + 25 + 9 * line, 0xffffff);
                drawString(fontRendererObj, "" + PacketTeamInfo.teamData[p].score, m + 100, n + 25 + 9 * line, 0xffffff);
                line++;
                for (int q = 0; q < PacketTeamInfo.teamData[p].numPlayers; q++) {
                    drawString(fontRendererObj, PacketTeamInfo.teamData[p].playerData[q].username, m + 8, n + 25 + 9 * line, 0xffffff);
                    drawString(fontRendererObj, "" + PacketTeamInfo.teamData[p].playerData[q].score, m + 100, n + 25 + 9 * line, 0xffffff);
                    drawString(fontRendererObj, "" + PacketTeamInfo.teamData[p].playerData[q].kills, m + 150, n + 25 + 9 * line, 0xffffff);
                    drawString(fontRendererObj, "" + PacketTeamInfo.teamData[p].playerData[q].deaths, m + 200, n + 25 + 9 * line, 0xffffff);
                    line++;
                }
            }
        } else {
            for (int q = 0; q < PacketTeamInfo.teamData[0].numPlayers; q++) {
                drawString(fontRendererObj, PacketTeamInfo.teamData[0].playerData[q].username, m + 8, n + 25 + 9 * line, 0xffffff);
                drawString(fontRendererObj, "" + PacketTeamInfo.teamData[0].playerData[q].score, m + 100, n + 25 + 9 * line, 0xffffff);
                drawString(fontRendererObj, "" + PacketTeamInfo.teamData[0].playerData[q].kills, m + 150, n + 25 + 9 * line, 0xffffff);
                drawString(fontRendererObj, "" + PacketTeamInfo.teamData[0].playerData[q].deaths, m + 200, n + 25 + 9 * line, 0xffffff);
                line++;
            }
        }
        GL11.glDisable(3042 /*GL_BLEND*/);
